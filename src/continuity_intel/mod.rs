...
//! dedup/rank primitives the engine (CT-P2) composes.

// The type surface is consumed by CT-P1 (the first detector) and CT-P2 (the
// engine); until they land it is scaffolding. Drop this allow then.
#![allow(dead_code)]
