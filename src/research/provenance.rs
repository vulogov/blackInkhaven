...
impl SourceRecord {
    ...
    pub(super) fn summary(&self) -> String {
        match self.origin.as_str() {
            ...
            "simulation" if !self.detail.is_empty() => format!("simulation · {}", self.detail),
            ...
            "archive" if !self.detail.is_empty() => format!("archive: {}", self.detail),
            "archive" => "archive (Internet Archive)".to_string(),
            "wikisource" if !self.detail.is_empty() => format!("wikisource: {}", self.detail),
            "wikisource" => "wikisource".to_string(),
