...
(~116 pages, B5). To rebuild it from source you need [Typst](https://typst.app):
...
- **Chapters:** [`chapters/`](chapters/) — one file per chapter, grouped into
  eight parts plus three appendices.
...
6. **A writing system** — designing glyphs and compiling a real font.
7. **The books** — producing the dictionary, grammar, and tutorial.
8. **A complete walkthrough** — building one language end to end.
