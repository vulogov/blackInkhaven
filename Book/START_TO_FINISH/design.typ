...
#let book_title    = "A Book, Start to Finish"
#let book_subtitle = "One Manuscript from Blank Project to Published Page"
...
#let book(pages) = {
  ...
  block(width: 100%, height: 100%)[
    ...
    #place(top + center, dy: 60mm, block(width: 74%)[
      ...
      #align(center)[
        #text(font: body_family, size: 12pt, tracking: 4pt, fill: ink_smoke, upper("One Manuscript, End to End"))
        #v(11mm)
