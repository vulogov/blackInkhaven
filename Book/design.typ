...
#let book_title  = "The Book of Inkhaven"
#let book_subtitle = "An Author's Guide to the Literary TUI"
#let book_authors = ("Vladimir Ulogov", "(and the inkhaven contributors)")
...
#let book(pages) = {
  ...
  align(left)[
    #text(font: body_family, size: 9pt, fill: ink_gray,
      "The Book of Inkhaven — companion guide to the inkhaven TUI literary editor."
    )
    #v(4mm)
    #text(font: body_family, size: 9pt, fill: ink_gray,
      "Source: " + h(2pt) + raw("https://github.com/vulogov/blackInkhaven", lang: "txt"),
    )
    #v(4mm)
    #text(font: body_family, size: 9pt, fill: ink_gray,
      "Typeset with Typst. Inkhaven binary versions are matched against book versions via the front-matter version string."
    )
  ]
  pagebreak()
