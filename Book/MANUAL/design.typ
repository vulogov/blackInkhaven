...
#let book_title    = "The Inkhaven Manual"
#let book_subtitle = "The Complete Guide to Writing a Book in the Terminal"
...
#let book(pages) = {
  ...
  block(width: 100%, height: 100%)[
    ...
    #place(top + center, dy: 60mm, block(width: 74%)[
      ...
      #align(center)[
        #text(font: body_family, size: 12pt, tracking: 4pt, fill: ink_smoke, upper("Writing Books in the Terminal"))
        #v(11mm)
