...
#grid(
  ...
  [
    ...
    the same instinct into the poetry engine this book describes: it measures a line
    and never invents a verdict it cannot account for — and it never writes the poem.
  ],
)
...
the work. Inkhaven's poetry layer grew the same way: the metre engine written to scan
invented languages turned out, with no extra machinery, to scan real verse just as well.
...
people who will never meet. If this book helps you hear a poem a little more clearly —
one of your own, or one you are reading closely for the first time — that is enough.
...
#text(font: body_family, style: "italic", size: 11pt, fill: ink_gray,
  "If the tool ever gets in the way of the poem instead of out of it, open an issue on GitHub. The author reads them."
)
