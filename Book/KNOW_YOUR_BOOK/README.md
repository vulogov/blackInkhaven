...
reads (LECTOR), how its voices sound (CHORUS), whether it is getting better draft to
draft (CHRONICLE), and what it all rests on (CANON, the decision ledger). For fiction
and non-fiction authors alike, assuming no prior knowledge.
...
- **IV · Knowing Where You Stand** — did it get better? (CHRONICLE); what the book
  rests on (CANON, the decision ledger).
