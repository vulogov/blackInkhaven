...
| -------- | ---------- | ------------------------------------ | ---------- |
| **1.2.7** | _in flight_ | [`1.2.7.md`](1.2.7.md)             | **Polish pass on the timeline-heavy 1.2.6 release.** Planned themes: project-overlay book-slug prefix; `inkhaven export timeline` (SVG/PNG/Typst); cascade-impact AI on event moves; Scrivener `<CustomMeta>` date-import bridge; F11-on-paragraph "suggest event" variant; real-project bug reports surfacing in the first weeks after the timeline ship. Living scratchpad — see [`1.2.7.md`](1.2.7.md) for the current state. |
