...
| `style_warnings.filter_words.extra_words` | array | `[]` | 1.2.9+. User-supplied words added on top of the language default. Case-insensitive; one entry per word. Example: `["totally", "obviously"]`. |
