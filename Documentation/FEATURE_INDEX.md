...
The canonical map of Inkhaven's features as of the **3.0.0** freeze: what each one is, how you reach it (CLI verb and/or editor chord), its authoritative doc, and its scripting surface. Use this as the maintenance reference — every user-facing feature should appear here with at least a doc.

Legend: **CLI** = `inkhaven <verb>` · **Chord** = in-editor keystroke · **Doc** = the topic guide · **Bund** = the `ink.*` scripting namespace (read-only unless noted).
...
| Writing goals & streaks | `goals` | `Ctrl+V g` / `Ctrl+B Shift+G` | [Tutorial](Tutorials/README.md) | — |
...
| Reasoning rigor | `rigor` | — | [RIGOR.md](RIGOR.md) | — |
| Companions cockpit | `companions` | — | [MAINTENANCE.md](MAINTENANCE.md) | — |
...
| WordNet thesaurus | `wordnet` | `Ctrl+V Shift+Y` | [Tutorial 109](Tutorials/README.md) | — |
...
| Feature | CLI | Chord | Doc | Bund |
|---|---|---|---|---|
| Research assistant | `research` | (own TUI) | [RESEARCH book](../Book/RESEARCH) | — |
...
| Index Locorum / Verborum | `index-locorum` · `index-verborum` | — | [SCHOLARLY_APPARATUS.md](SCHOLARLY_APPARATUS.md) | — |
...
| AI cost dashboard | `cost` | `Ctrl+B $` | [MAINTENANCE.md](MAINTENANCE.md) | — |
| Project doctor | `doctor` | `Ctrl+B Shift+0` | [MAINTENANCE.md](MAINTENANCE.md) | — |
...
| Backup / restore / reindex | `reindex` | — | [MAINTENANCE.md](MAINTENANCE.md) | — |
